...
async function addOtherEntry(event) {
  ...
  window.insertTemplate = function (templateNumber) {
    ...
    const templates = [
      "Сброс ошибки на УПП конвейера выброса мелкой фракции 159U1.",
      "Плановый пуск ДГУ с синхронизацией с сетью.",
      "Отключен АВ 1 зоны ФКВО. Вывешен плакат 'Не включать! Работают люди!'.",
    ];
